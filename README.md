...
1.  Savings (7% interest rate)
2.  Current (no interest)
3.  Fixed Deposit:
...
### Account Operations
For viewing account details: Enter the account ID

For transactions: Select account and choose deposit or withdraw

For updates: Select account and choose field to update

For transfers: Enter account ID and recipient username
